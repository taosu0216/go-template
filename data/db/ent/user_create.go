...
func (uc *UserCreate) SetIsVip(b bool) *UserCreate {
	uc.mutation.SetIsVip(b)
	return uc
}

// SetNillableIsVip sets the "is_vip" field if the given value is not nil.
func (uc *UserCreate) SetNillableIsVip(b *bool) *UserCreate {
	if b != nil {
		uc.SetIsVip(*b)
	}
	return uc
...
func (uc *UserCreate) SetCreateTime(s string) *UserCreate {
	uc.mutation.SetCreateTime(s)
	return uc
}
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.IsVip(); !ok {
		v := user.DefaultIsVip
		uc.mutation.SetIsVip(v)
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.IsVip(); ok {
